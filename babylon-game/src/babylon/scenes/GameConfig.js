...
export const LIGHTS = {
  ...
  PLAYER_BEAM_HEIGHT: 16,        // hauteur du cône (unités)
  PLAYER_BEAM_TOP_DIAM: 0.3,     // diamètre en haut (pointe)
  PLAYER_BEAM_BOT_DIAM: 5.0,     // diamètre en bas (base au sol)
  PLAYER_BEAM_COLOR: [1.0, 0.82, 0.45], // jaune chaud
  PLAYER_BEAM_ALPHA: 0.01,       // transparence du faisceau
}
...
export const ROUND = {
  ...
  TIME_LIMIT_BASE: 60,    // timelimit = TIME_LIMIT_BASE + r * TIME_LIMIT_STEP
  TIME_LIMIT_STEP: 30,
  TIME_BEFORE: 3,
